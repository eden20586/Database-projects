...
--
-- Table structure for table `customers_in_licensed_garages`
--

DROP TABLE IF EXISTS `customers_in_licensed_garages`;
...
--
-- Dumping data for table `customers_in_licensed_garages`
--

LOCK TABLES `customers_in_licensed_garages` WRITE;
/*!40000 ALTER TABLE `customers_in_licensed_garages` DISABLE KEYS */;
INSERT INTO `customers_in_licensed_garages` VALUES ('90','54');
/*!40000 ALTER TABLE `customers_in_licensed_garages` ENABLE KEYS */;
UNLOCK TABLES;
