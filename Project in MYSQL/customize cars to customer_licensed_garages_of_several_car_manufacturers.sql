...
--
-- Table structure for table `licensed_garages_of_several_car_manufacturers`
--

DROP TABLE IF EXISTS `licensed_garages_of_several_car_manufacturers`;
...
--
-- Dumping data for table `licensed_garages_of_several_car_manufacturers`
--

LOCK TABLES `licensed_garages_of_several_car_manufacturers` WRITE;
/*!40000 ALTER TABLE `licensed_garages_of_several_car_manufacturers` DISABLE KEYS */;
INSERT INTO `licensed_garages_of_several_car_manufacturers` VALUES ('mazda','54'),('mazda','55'),('toyota','56'),('subaru','57');
/*!40000 ALTER TABLE `licensed_garages_of_several_car_manufacturers` ENABLE KEYS */;
UNLOCK TABLES;
